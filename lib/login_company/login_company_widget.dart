...
import 'login_company_model.dart';
export 'login_company_model.dart';

class LoginCompanyWidget extends StatefulWidget {
  const LoginCompanyWidget({Key? key}) : super(key: key);

  @override
  _LoginCompanyWidgetState createState() => _LoginCompanyWidgetState();
}

class _LoginCompanyWidgetState extends State<LoginCompanyWidget> {
  late LoginCompanyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginCompanyModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          context.pushNamed('signupCompany');
                        },
                        child: Text(
                          'Sign Up',
                          style:
